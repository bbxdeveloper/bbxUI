...
import { CustomerDiscountManagerComponent } from './customer-discount-manager/customer-discount-manager.component';
...
@NgModule({
  declarations: [
    CustomerDiscountManagerComponent,
    ProductGroupSelectTableDialogComponent
  ],
  imports: [
    CommonModule,
    NbLayoutModule,
